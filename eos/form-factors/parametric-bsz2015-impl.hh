...
namespace eos
{
    ...
    const std::map<std::tuple<QuarkFlavor, QuarkFlavor>, std::string> BSZ2015FormFactorTraits<Process_, PToV>::resonance_0m_names{
    ...
    template <typename Process_>
    const std::map<std::tuple<QuarkFlavor, QuarkFlavor>, std::string> BSZ2015FormFactorTraits<Process_, PToV>::resonance_1m_names{
        { std::make_tuple(QuarkFlavor::bottom,      QuarkFlavor::up), "mass::B_u^*@HME" },
        { std::make_tuple(QuarkFlavor::bottom,    QuarkFlavor::down), "mass::B_d^*@HME" },
        { std::make_tuple(QuarkFlavor::bottom, QuarkFlavor::strange), "mass::B_s^*@HME" },
        { std::make_tuple(QuarkFlavor::bottom,   QuarkFlavor::charm), "mass::B_c^*@HME" },
    ...
    template <typename Process_>
    const std::map<std::tuple<QuarkFlavor, QuarkFlavor>, std::string> BSZ2015FormFactorTraits<Process_, PToV>::resonance_1p_names{
    ...
    BSZ2015FormFactors<Process_, PToV>::BSZ2015FormFactors(const Parameters & p, const Options &) :
        ...
        _a_A1{ { UsedParameter(p[_par_name("A1_0")], *this), UsedParameter(p[_par_name("A1_1")], *this), UsedParameter(p[_par_name("A1_2")], *this) } },
        ...
        _a_T23{ { UsedParameter(p[_par_name("T23_0")], *this), UsedParameter(p[_par_name("T23_1")], *this), UsedParameter(p[_par_name("T23_2")], *this) } },
        _a_A12{ { UsedParameter(p[_par_name("A12_1")], *this), UsedParameter(p[_par_name("A12_2")], *this) } },
        _a_T2{ { UsedParameter(p[_par_name("T2_1")], *this), UsedParameter(p[_par_name("T2_2")], *this) } }, _traits(p), _mB(_traits.m_B), _mV(_traits.m_V)
    {
        this->uses(_traits);
    }

    template <typename Process_> BSZ2015FormFactors<Process_, PToV>::~BSZ2015FormFactors() {}
    ...
    // P -> P
    template <typename Process_>
    const std::map<std::tuple<QuarkFlavor, QuarkFlavor>, std::string> BSZ2015FormFactorTraits<Process_, PToP>::resonance_0p_names{
    ...
    template <typename Process_>
    const std::map<std::tuple<QuarkFlavor, QuarkFlavor>, std::string> BSZ2015FormFactorTraits<Process_, PToP>::resonance_1m_names{
        { std::make_tuple(QuarkFlavor::bottom,      QuarkFlavor::up), "mass::B_d^*@HME" },
        { std::make_tuple(QuarkFlavor::bottom,    QuarkFlavor::down), "mass::B_d^*@HME" },
        { std::make_tuple(QuarkFlavor::bottom, QuarkFlavor::strange), "mass::B_s^*@HME" },
        { std::make_tuple(QuarkFlavor::bottom,   QuarkFlavor::charm), "mass::B_c^*@HME" },
        {  std::make_tuple(QuarkFlavor::charm,    QuarkFlavor::down), "mass::D_d^*@HME" },
    ...
    template <typename Process_> BSZ2015FormFactors<Process_, PToP>::~BSZ2015FormFactors() {}
